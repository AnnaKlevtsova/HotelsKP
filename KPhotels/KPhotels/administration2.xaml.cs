            ...
            else
            {
                switch (TableName.Text)
                {
                    ...
                    case "hotels":
                        ...
                        {
                            if ((int.TryParse(textboxs[5].Text, out int result)) == true)
                            {
                                ...
                                else MessageBox.Show("Количество номеров должно быть не больше 25 и не меньше 0");
                            }
                            else MessageBox.Show("Количество номеров должно быть числом");
                        }
                        else MessageBox.Show("Пустое поле");
                        break;
